      ...
      <Panel tab="Filters" tabIcon="filter_alt" className="mb-4">
        <div className="flex flex-wrap gap-6">
          <div>
            ...
            <FilterPills ariaLabel="Filter by status" options={['All', ...TICKET_STATUSES]} value={status} onChange={setStatus} />
          </div>
          <div>
            <p className="field-label">Category</p>
            <FilterPills ariaLabel="Filter by category" options={['All', ...TICKET_CATEGORIES]} value={category} onChange={setCategory} />
          </div>
        </div>
      </Panel>
